<x-app-layout>
    @if(!$customOrder->product_id)
        {{-- ─── ARDIMAN'S STANDALONE CUSTOM ORDER LAYOUT ─── --}}
        <x-slot name="header">
                        ...
                        <div class="relative z-10 flex justify-between">
                            ...
                            <div class="flex flex-col items-center w-24 text-center">
                                @if($currentStepIndex === 5)
                                    ...
                                    <span class="text-xs font-bold text-emerald-650 dark:text-emerald-455 mt-3">Selesai</span>
                                @else
                                    <div class="w-10 h-10 rounded-2xl flex items-center justify-center bg-gray-100 dark:bg-gray-800 text-gray-455 dark:text-gray-500 font-semibold ring-4 ring-white dark:ring-gray-900">
                                        7
                                    </div>
                        ...
                        <div class="bg-white dark:bg-gray-900 overflow-hidden shadow-xl sm:rounded-3xl border border-gray-100 dark:border-gray-800 p-6 md:p-8 space-y-6">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-5">
                                ...
                                @if($customOrder->category === 'konveksi')
                                    <div>
                                        <span class="text-xs font-bold text-gray-400 dark:text-gray-550 uppercase tracking-wider block">Ukuran</span>
                                        <span class="text-sm font-semibold text-gray-900 dark:text-white mt-1 block">
                                            {{ $customOrder->size ?? '-' }}
                                        </span>
                                    </div>
                            ...
                            @if($customOrder->notes)
                                <div class="bg-gray-50/50 dark:bg-gray-955/20 rounded-2xl p-5 border border-gray-100 dark:border-gray-800">
                                    <span class="text-xs font-bold text-gray-400 dark:text-gray-555 uppercase tracking-wider block mb-2">Catatan Tambahan</span>
                                    <p class="text-sm text-gray-750 dark:text-gray-305 leading-relaxed font-medium">{{ $customOrder->notes }}</p>
                                </div>
                            @endif
                        </div>
                    </div>
    ...
    @else
        {{-- ─── REZA'S BASIS PRODUCT CUSTOM ORDER LAYOUT WITH CHAT ─── --}}
        <x-slot name="header">
        ...
        <div class="py-12" x-data="{
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                {{-- Alert Toast / Success Message --}}
                @if(session('success'))
                    <div class="mb-6 p-4 rounded-xl bg-emerald-50 border border-emerald-250 text-emerald-700 dark:bg-emerald-950/20 dark:border-emerald-900/50 dark:text-emerald-400">
                        {{ session('success') }}
                    </div>
                @endif
                @if(session('error'))
                    <div class="mb-6 p-4 rounded-xl bg-red-50 border border-red-250 text-red-750 dark:bg-red-950/20 dark:border-red-900/50 dark:text-red-400">
                        {{ session('error') }}
                    </div>
                @endif

                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    {{-- Left Column: Details & Mockup --}}
                    <div class="space-y-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <div class="font-medium mt-0.5">{{ $customOrder->category ?? '-' }}</div>
                                    </div>
                                    <div>
                                        <div class="text-sm text-gray-500">Bahan</div>
                                        <div class="font-medium mt-0.5">{{ $customOrder->material ?? '-' }}</div>
                                    </div>
                                    <div>
                                        <div class="text-sm text-gray-500">Jumlah</div>
                                        <div class="font-medium mt-0.5">{{ $customOrder->quantity }} pcs</div>
                                    </div>
                                    <div>
                                ...
                                <div>
                                    <div class="text-sm text-gray-500">Desain Awal (Dari Anda)</div>
                        ...
                        @if($customOrder->admin_design_path)
                            <div class="bg-white dark:bg-zinc-900 p-6 rounded-2xl shadow-sm border border-violet-250 dark:border-violet-900/50 relative overflow-hidden">
                    ...
                    <div class="lg:col-span-2 flex flex-col bg-white dark:bg-zinc-900 rounded-2xl shadow-sm border border-gray-100 dark:border-zinc-800 h-[500px] lg:h-[650px]">
