...
<div class="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800 mb-8">
    ...
    <a href="{{ asset('storage/' . $transaction->payment_proof_path) }}" target="_blank">
        <img src="{{ asset('storage/' . $transaction->payment_proof_path) }}" alt="Bukti Transfer" class="max-w-md rounded-lg border border-gray-200 dark:border-gray-700">
    </a>
</div>
@endif
